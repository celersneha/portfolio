...
export default function AboutClient() {
  const [tab, setTab] = useState<"intro" | "resume" | "experience">("intro");
  const [prevTab, setPrevTab] = useState<"intro" | "resume" | "experience">(
    "intro"
  );
  ...
  const handleTabChange = (nextTab: "intro" | "resume" | "experience") => {
    setPrevTab(tab);
    setTab(nextTab);
  };
